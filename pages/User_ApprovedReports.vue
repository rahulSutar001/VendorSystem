<template>
    <div class="">
        ...
        <div class=" sm:hidden grow ml-7 mt-8 text-center bg-white pb-1 ">
            <button class="border-b-2 cursor-default font-semibold text-md lg:text-lg md:text-base  ">Approved
                Reports</button>
        </div>
        ...
        <div class="flex flex-wrap flex-row  w-full py-2 sm:mt-8 mt-0">
            ...
            <div class=" sm:inline-flex hidden grow ml-5 mt-1">
                <button class="border-b-2 cursor-default font-semibold text-sm lg:text-lg md:text-base  ">Approved
                    Reports</button>
            </div>
                        ...
                        <tbody>
                            ...
                            <tr v-for="( data, index) in paginatedData" :key="index">
                                ...
                                <td>
                                    ...
                                    <div><button
                                            class=" flex justify-center cursor-default bg-green-600  text-gray-100 px-1 py-1 mx-1   rounded-sm tracking-wide font-sm  shadow-sm  ">{{
...
//get method
// const { data: resDataSuccess } = await useFetch('api/fetchreport/fetchreportApproved_User', {
//     method: 'POST',
...
onMounted(async () => {
    ...
    const resDataSuccess = $fetch("/api/fetchreport/fetchreportApproved_User")
        .then((res) => {
            Data.value = res
        })
