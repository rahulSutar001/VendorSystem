                        ...
                        <tbody>
                            ...
                            <tr v-for="( data, index) in paginatedData" :key="index">
                                ...
                                <td>
                                    <div class="">
                                        <div><button
                                                class=" flex w-20 cursor-default justify-center bg-red-500  text-gray-100 px-1 py-1 mx-1   rounded-sm tracking-wide font-sm  shadow-sm  ">{{
                ...
                <div class="text-center mt-5">
                    ...
                    <div class="flex flex-wrap justify-center">
                        <div class=" text-center">
                            <div>
                                <button
                                    class=" flex w-20 justify-center bg-red-500  hover:bg-red-400 text-gray-100 px-1 py-1 mx-1   rounded-sm tracking-wide font-sm  shadow-sm cursor-default transition ease-in duration-200 ">{{
                                        data.Admin }}</button>
                            </div>
                        </div>
                    </div>
