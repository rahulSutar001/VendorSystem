<template>
    <div class="">
        ...
        <div class="  ml-5   w-full rounded-2xl">
                        ...
                        <tbody>
                            ...
                            <tr v-for="( data, index) in paginatedData" :key="index">
                                ...
                                <td>
                                    ...
                                    <div><button
                                            class=" flex w-20 justify-center bg-green-600 cursor-default  text-gray-100 px-1 py-1 mx-1   rounded-sm tracking-wide font-sm  shadow-sm  ">{{
                ...
                <div class="text-center mt-5">
                    ...
                    <div class="">
                        ...
                        <div class=" text-center">
                            <div>
                                <button
                                    class="w-20 flex justify-center bg-green-600  hover:bg-green-400 text-gray-100 px-1 py-1 mx-1   rounded-sm tracking-wide font-sm  shadow-sm cursor-pointer transition ease-in duration-200 ">{{
            ...
            <div class="text-center  " v-if="Data.length > limit">

                <div class="text-center mt-2" v-if="Data.length > limit">
                    <div class="mr-5">
...
// // get method
// const { data: resDataSuccess } = await useFetch('api/fetchreport/fetchreportauthoriser_approved', {
//     method: 'POST',
