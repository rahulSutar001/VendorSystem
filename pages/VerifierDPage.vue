...
async function approvereport(value: any) {
    await $fetch('/api/Decision_Api/decision_verfier_approved_rejected', {
        method: 'POST',
        body: {
            "ReportId": value,
            "Approve": "True",
...
//get method
// const { data: resDataSuccess } = await useFetch('/api/Verifier_Api/Getreport_to_verfier', {
//     method: 'GET',
...
onMounted(() => {
    ...
    const resDataSuccess = $fetch("/api/Verifier_Api/Getreport_to_verfier")
        .then((res) => {
            Data.value = res
        })
