...
function _sfc_ssrRender(_ctx, _push, _parent, _attrs, $props, $setup, $data, $options) {
  ...
  _push(`</div></div></div></div><div class="drawer-side"><label for="my-drawer" class="drawer-overlay"></label><div class="w-3/4 h-full bg-base-200 text-base-content"><div class="flex flex-col pt-5 justify-between bg-blue-500" style="${ssrRenderStyle({ "height": "94vh" })}"><div class="flex flex-col space-y-3"><div class="flex items-center"><a href="/VerifierDPage"><button class="flex" title="Home"><i class="fa fa-th text-white bg-slate-100 p-1 bg-opacity-30 mx-3 mt-4" style="${ssrRenderStyle({ "font-size": "26px" })}"></i><p class="text-white mt-5 font-light">Home</p></button></a></div><div class="flex items-center"><a href="/VerifierApproveReport"><button class="flex items-center" title="Approved Report"><img class="bg-slate-100 p-1 bg-opacity-30 mx-3 my-2 h-9 w-9"${ssrRenderAttr("src", _imports_1)} style="${ssrRenderStyle({ "font-size": "20px" })}" alt=""><p class="text-white font-light">Approved Reports</p></button></a></div><div class="flex items-center"><a href="/VerifierRejectedReports"><button class="flex items-center" title="Rejected Report"><img${ssrRenderAttr("src", _imports_2)} style="${ssrRenderStyle({ "font-size": "20px" })}" class="bg-slate-100 p-1 bg-opacity-30 mx-3 my-2 h-9 w-9"><p class="text-white font-light">Rejected Reports</p></button></a></div><div class="flex items-center"><a href="/VerifierRequestRecheck"><button class="flex items-center" title="Recheck Requested"><img${ssrRenderAttr("src", _imports_3)} class="bg-slate-100 p-1 bg-opacity-30 mx-3 my-2 h-9 w-9"><p class="text-white font-light text-sm">Recheck Requested</p></button></a></div></div><div class="mb-11"><button class="flex" title="Signout"><i class="fa fa-sign-out text-white bg-slate-100 px-2 py-1 rounded-lg bg-opacity-30 mx-3 my-3" style="${ssrRenderStyle({ "font-size": "18px" })}"></i><p class="text-white font-light text-sm mt-4">Log out</p></button></div></div></div></div></div>`);
}
const _sfc_setup = _sfc_main.setup;
_sfc_main.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("layouts/verifierlayout.vue");
  return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};
const verifierlayout = /* @__PURE__ */ _export_sfc(_sfc_main, [["ssrRender", _sfc_ssrRender]]);

export { verifierlayout as default };
//# sourceMappingURL=verifierlayout-adf50a37.mjs.map
