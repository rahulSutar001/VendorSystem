...
const _sfc_main = {
  ...
  methods: {
    ...
    goToPage1() {
      this.$router.push("/User_DPage");
    },
    goToPage2() {
      this.$router.push("/User_ApprovedReports");
    },
    goTopage3() {
      this.$router.push("/User_RejectedReports");
    },
    goTopage4() {
      this.$router.push("/User_createReport");
    },
    goTopage5() {
      this.$router.push("/User_RequestRecheck");
    }
  },
  mounted() {
